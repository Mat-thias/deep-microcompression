...
// /**
//  * @brief Forward pass for quantized MaxPool2d
//  * @param input Pointer to quantized input tensor (int8_t) in CHW format
//  * @param output Pointer to quantized output tensor (int8_t) in CHW format
//  * 
//  * Performs 2D max pooling operation on quantized input.
//  * The input is assumed to be in CHW (channels, height, width) format.
//  */
// void MaxPool2d::forward(int8_t* input, int8_t* output) {
//     int8_t temp, input_val;
